...
class thirtyTo45 extends StatelessWidget {
  const thirtyTo45({Key? key}) : super(key: key);
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  Text(
                    "Choose a variety of vegetables, including dark green, red and orange, beans and peas, starchy and non-starchy. Eat a variety of fruits such as apple,banana,orange.Mostly prefer to eat seasonal fruits. Include grains in your daily diet. Half of your grains should be whole grains such as wheat,rice,bajara. Stick to fat-free or low-fat dairy. This includes milk, yogurt, cheese, or fortified soy products. Have protein at every meal. Healthy protein includes lean meat (chicken), seafood, eggs, beans and peas, nuts, seeds, and soy products. Use healthy oils, such as olive oil. Additionally, women should consume: Less than 10% of your daily calories from added sugars (desserts and processed foods) Less than 10% of daily calories from saturated fats (red meat, high-fat dairy) Less than 2,300 milligrams (mg) per day of sodium. Not more than one drink per day of alcohol Calcium, dietary fiber, potassium, vitamin A and vitamin C.",
                    style: TextStyle(
                        color: black,
                        fontSize: 15,
                        fontWeight: FontWeight.w700,
